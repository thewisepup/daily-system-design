...
export default function ConfirmationModal({
  ...
  const handleConfirm = () => {
    ...
    if (requiredInput && inputValue.toLowerCase().trim() !== requiredInput.toLowerCase()) {
  ...
  const getConfirmButtonClasses = () => {
    const baseClasses = "flex-1 rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white shadow-sm focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50";
          ...
          <div className="mb-4">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full ${
                ...
                confirmButtonColor === 'green' ? 'bg-green-100' : 
                confirmButtonColor === 'yellow' ? 'bg-yellow-100' : 
                'bg-indigo-100'
              }`}>
