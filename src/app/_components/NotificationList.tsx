...
function NotificationItem({ notification, onDismiss }: NotificationItemProps) {
  ...
  return (
    <div className={`rounded-md border p-3 shadow-sm ${getNotificationStyles()}`}>
      <div className="flex items-start justify-between">
        ...
        <button
          ...
          className="ml-3 flex-shrink-0 rounded-md hover:bg-black/5 p-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent"
          title="Dismiss notification"
        >
          <svg className="h-4 w-4 opacity-60 hover:opacity-100" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
export default function NotificationList({ 
  ...
  return (
    <div className={getPositionClasses()}>
      <div className={`space-y-2 ${position !== 'inline' ? 'pointer-events-auto w-80' : ''}`}>
