...
describe("ValidationSchemas", () => {
  describe("userId", () => {
    ...
    it("rejects non-string values", () => {
      expect(() => ValidationSchemas.userId.parse(123 as any)).toThrow(
        z.ZodError,
      );
    });
  ...
  describe("userIds", () => {
    ...
    it("rejects non-array values", () => {
      expect(() =>
        ValidationSchemas.userIds.parse("not-an-array" as any),
      ).toThrow(z.ZodError);
    });
  });
  ...
  describe("subjectId", () => {
    ...
    it("rejects non-number values", () => {
      expect(() => ValidationSchemas.subjectId.parse("1" as any)).toThrow(
        z.ZodError,
      );
    });
  });
