...
export const MODAL_CONFIGS = {
  approve: {
    ...
    message: 'Are you sure you want to approve this newsletter? It will be ready for sending.',
    confirmText: 'Approve',
  ...
  unapprove: {
    ...
    title: 'Move to Draft',
    message: 'Are you sure you want to move this newsletter back to draft status?',
  ...
  sendEmail: {
    ...
    message: 'Are you sure you want to send this newsletter to the admin email for testing?',
